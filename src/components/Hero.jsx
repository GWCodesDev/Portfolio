        ...
        <div className="space-y-8 holographic-container w-full">
          ...
          <div className="space-y-6 text-center sm:text-left">
            ...
            <div className="flex gap-6 pt-6 justify-center sm:justify-start border-t border-white/5">
              <a href="https://github.com/GWCodesDev" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-emerald-400 transition-colors text-sm font-mono">
              ...
              <a href="https://www.linkedin.com/in/gwcodes/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-emerald-400 transition-colors text-sm font-mono">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
